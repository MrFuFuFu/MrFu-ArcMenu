...
public class ArcLayout extends ViewGroup {
    ...
    private static final int MIN_RADIUS = 200;//100
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
//            Log.i("MrFu", "getChildAt(i).getId() = " + getChildAt(i).getId());
//            Log.i("MrFu", "getChildAt(i).getX() = " + getChildAt(i).getX());
//            Log.i("MrFu", "getChildAt(i).getY() = " + getChildAt(i).getY());
//            Log.i("MrFu", "getChildAt(i).getTop() = " + getChildAt(i).getTop());
            switch (i) {
			case 0:
//				mX_left = getChildAt(i).getX();
				mX_left = getChildAt(i).getLeft();
//				mY_left = getChildAt(i).getY();
				mY_left = getChildAt(i).getTop();
				break;
			case 1:
//				mX_right = getChildAt(i).getX();
				mX_right = getChildAt(i).getLeft();
//				mY_right = getChildAt(i).getY();
				mY_right = getChildAt(i).getTop();
				break;
			default:
				break;
			}
        }
        mOnGetPostionListener.onGetPostion(mExpanded, mX_left, mY_left, mX_right, mY_right);
    }
    
    private float mX_left, mY_left, mX_right, mY_right;
    OnGetPostionListener mOnGetPostionListener;
    
    public void setOnGetPostionListener(OnGetPostionListener onGetPostionListener){
    	mOnGetPostionListener = onGetPostionListener;
    }
    
    public interface OnGetPostionListener{
    	/**总共两个弹窗，写死**/
    	void onGetPostion(boolean mExpanded, float x_left, float y_left, float x_right, float y_right);
    }
